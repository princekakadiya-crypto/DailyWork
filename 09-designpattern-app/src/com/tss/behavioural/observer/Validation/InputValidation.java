package com.tss.behavioural.observer.Validation;
...
public class InputValidation {
    ...
    public static String readNumberWithLength(String message, int minLength, String s, int maxLength, String lengthmessage) {
        String input;
        while (true) {
            System.out.print(message);
